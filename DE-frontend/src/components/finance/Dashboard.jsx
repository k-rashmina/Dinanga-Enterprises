  ...
  return (
    ...
    <>
      ...
      <div className="d-flex flex-wrap justify-content-between ps-5 pe-5 ms-5 me-5 pt-5" style={{position: 'relative'}}>
        ...
        <div className="align-self-center rounded-5 div-shadow  ps-4 pb-4 example example1" style={{ width: '500px', height: '250px', overflow: 'scroll', position: 'relative', backgroundColor: '#CBFAE0' }}>
        ...
        <div className="align-self-center rounded-5 div-shadow  ps-4 pb-4 example example1" style={{ width: '500px', height: '250px', overflow: 'scroll', position: 'relative', backgroundColor: '#FCC8D4' }}>
        ...
        <h4 className="mb-4 mt-5" style={{ width: '500px'}}>Generate Monthly Transaction Report</h4>

        <button className="align-self-center form-button fw-semibold" style={{position: 'absolute', left: '522px', right: '522px', top: '480px', width: '200px'}} onClick={handleGenerateReport}>Generate Report</button>

    ...
    const fetchListings = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5000/inventory/weeklyConsumedStocks"
        );
        ...
        <table className="table-hover example1 " style={{ width: "990px" }}>
          <thead style={{ fontSize: "18px", height: "56px" }}>
            ...
            >
              ...
              <th style={{ width: "258px" }}>Sold Items(qty)</th>
              <th style={{ width: "206px" }}>Unit Sold Price</th>
              <th style={{ width: "140px" }}>Decreased Stock Value</th>
            </tr>
          </thead>
          <tbody className="">

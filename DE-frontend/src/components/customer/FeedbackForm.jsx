...
const FeedbackForm = () => {
  ...
  const handleSubmit = (event) => {
    ...
    axios.post("http://localhost:5000/cusfeedback/addcustomerfeedbacks", feedbackData)
      .then(() => {
        ...
        // Clear the feedback fields after successful submission
        setFeedbackData({
          cusEmail: loggedUser,
          feedbackSub: '',
          feedbackMsg:'',
  ...
  return (
    <div>
      <h2 style={{ color: '#393E46', textAlign: 'center', fontWeight: 'bold', marginTop: '20px' }}>Leave Your Valuable Feedback Here</h2>
